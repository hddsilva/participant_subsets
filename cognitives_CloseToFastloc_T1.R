...
#Create data table
cognitives_CloseToFastloc_T1 <- long_mri %>%
...
write.table(cognitives_CloseToFastloc_T1, file=paste("data_categories/cognitives/additional_cognitives/cognitives_CloseToFastloc_T1_",Sys.Date(),".txt",sep=""), sep="\t", row.names = FALSE)
