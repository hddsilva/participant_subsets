#Finds the MRRC_ID of each participant's most recent usable resting state. 
...
write.table(most_recent_rest, file=paste("data_categories/mri_data/additional_mri_data/most_recent/most_recent_rest_",Sys.Date(),".txt",sep=""), sep="\t", row.names = FALSE)
